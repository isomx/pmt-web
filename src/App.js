    ...
    return (
      <div className="App">
        <div className="App-header">
          ...
          <div className="App-subtitle"> DO NOT allow custom config for create-react-app without ejecting</div>
        </div>
        ...
        <div className={styles.description}>
          ...
          <p> If you want to enable/disable there certain features just modify the <b>.env</b> file in the root directory of
              the
              project.
          </p>
          ...
          <ul className="configs babel-configs">
            <li>
              <code>REACT_APP_BABEL_STAGE_0=true asdfasdf</code>
